...
import cz.hcasc.dagmar.net.Api
import cz.hcasc.dagmar.storage.SecureStore
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val appUrl: String = BuildConfig.DAGMAR_BASE_URL.trimEnd('/') + "/app"
...
private enum class InstanceState {
    UNKNOWN, PENDING, ACTIVE, REVOKED, DEACTIVATED
}

@OptIn(ExperimentalMaterial3Api::class)
@Composable
private fun DagmarApp(
    baseUrl: String,
    appUrl: String,
    store: SecureStore
) {
...
@Composable
private fun AccessLimitedScreen(
    modifier: Modifier = Modifier,
    instanceId: String?
) {
    Column(
